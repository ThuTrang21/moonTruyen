...
export const Navbar = () => {
  ...
  return (
    <div className="bg-primary flex items-center h-16 inset-0 dark:bg-black dark:text-white duration-200">
      <div className="px-3.5 flex items-center mx-auto w-full max-w-7xl">
        <div className="flex items-center gap-x-3 z-[999] relative">
          <img src={logo} alt="" className="w-44 sm:cursor-pointer dark:hidden" />
          <img
      src={logoLight}
      alt=""
        ...
        <div className="flex items-center gap-x-5 z-[999] relative ml-auto ">
          <div className="hidden sm:block group">
            <input
              ...
              className="dark:text-black w-[200px] 
              group-hover:w-[250px] transition-all duration-300 rounded-full border border-gray-300 px-3 py-1 focus:outline-none focus:border-1 focus:border-blue-400"
            />
            <SearchIcon className="text-gray-500 group-hover:text-primary -translate-x-7" />
          </div>
          <div>
            <DarkMode />
          </div>
          {!true ? (
            ...
            <IconButton>
              <PersonIcon className="dark:text-white" sx={{ fontSize: "33px" }} />
            </IconButton>
          )}
