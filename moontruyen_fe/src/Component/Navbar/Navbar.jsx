        ...
        <div className="flex items-center gap-x-5 z-[999] relative ml-auto ">
          <div className="hidden sm:block group mr-10 relative">
            <input
              ...
              className="dark:text-black w-[200px] transition-all duration-300 rounded-full border border-gray-300 px-3 py-1 focus:outline-none focus:border-1 focus:border-blue-400 pl-10" // Thêm padding-left để tạo không gian cho icon
            />
